...
class Settings:
    ...
    naver_delay_sec: tuple = (8, 16)
    naver_reset_every: int = 12
    naver_stop_after_fail: int = 6
...
def load(path: Path | None = None) -> Settings:
    ...
    return Settings(
        ...
        naver_delay_sec=tuple(s.get("naver_delay_sec") or [8, 16]),
        naver_reset_every=max(1, int(s.get("naver_reset_every", 12))),
        naver_stop_after_fail=max(1, int(s.get("naver_stop_after_fail", 6))),
        ...
        baseline_unstick_days=max(2, int(al.get("baseline_unstick_days", 5))),
        ...
        rt_freshness_days=max(1, int(al.get("rt_freshness_days", 3))),
